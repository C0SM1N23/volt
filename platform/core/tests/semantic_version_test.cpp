...
INSTANTIATE_TEST_SUITE_P(
    Cases,
    SemanticVersionEqualityTest,
    ::testing::Values(
        EqualityCase{"IdenticalVersionsAreEqual", SemanticVersion{1, 0, 0}, SemanticVersion{1, 0, 0}, true},
        EqualityCase{"DifferingPatchIsUnequal", SemanticVersion{1, 0, 0}, SemanticVersion{1, 0, 1}, false},
        EqualityCase{"DifferingMinorIsUnequal", SemanticVersion{1, 0, 0}, SemanticVersion{1, 1, 0}, false},
        EqualityCase{"DifferingMajorIsUnequal", SemanticVersion{1, 0, 0}, SemanticVersion{2, 0, 0}, false}),
